...
const Register = () => {
  ...
  const inputClass = (fieldError) =>
    `neu-inset w-full h-12 rounded-2xl px-4 text-sm text-white placeholder:text-[#6C6C6B] outline-none transition ${fieldError ? "shadow-[0_0_0_1.5px_#ef4444]" : ""
    }`;
  ...
  return (
    ...
    >
      <div className="neu w-full max-w-107.5 rounded-2xl px-7 py-6">
        {/* Logo */}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="mt-2">
            <div className="flex gap-2">
              <div
                className={`h-1.5 flex-1 rounded-full ${strength >= 1 ? "bg-volt" : "bg-gray-700"
                  }`}
              />

              <div
                className={`h-1.5 flex-1 rounded-full ${strength >= 3 ? "bg-volt" : "bg-gray-700"
                  }`}
              />

              <div
                className={`h-1.5 flex-1 rounded-full ${strength === 4 ? "bg-volt" : "bg-gray-700"
                  }`}
              />
            </div>
        ...
        <p className="mt-5 text-center text-sm text-muted">
          ...
          <span
            onClick={() => navigate("/")}
            className="ml-1 cursor-pointer font-semibold text-volt"
          >
            Sign in
          </span>
        </p>
