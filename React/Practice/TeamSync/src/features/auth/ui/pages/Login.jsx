                ...
                >
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center">
                            ...
                            <a
                                href="#"
                                className="text-xs text-[#755BB4] hover:text-[#8B74C9] transition-colors"
                            >
                                Forgot password?
                            </a>
                        </div>
                ...
                <div className="mt-8 text-center border-t border-[#2B2936] pt-6">
                    <p className="text-sm text-gray-400">
                        ...
                        <span
                            ...
                            className="cursor-pointer text-white font-semibold hover:text-[#755BB4] transition-colors"
                        >
                            Sign Up
                        </span>
                    </p>
