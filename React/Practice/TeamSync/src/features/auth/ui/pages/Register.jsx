                    ...
                    <div className="w-full max-w-md space-y-8">
                        <div>
                            ...
                            <p className="text-gray-400 mt-2">
                                Experience the future of collaborative data
                                intelligence.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="flex gap-1 pt-2">
                                    <div
                                        className={`h-1 flex-1 rounded-full transition-colors ${strength >= 1 ? "bg-[#A78BFA]" : "bg-[#2E375A]"}`}
                                    ></div>
                                    <div
                                        className={`h-1 flex-1 rounded-full transition-colors ${strength >= 2 ? "bg-[#A78BFA]" : "bg-[#2E375A]"}`}
                                    ></div>
                                    <div
                                        className={`h-1 flex-1 rounded-full transition-colors ${strength >= 3 ? "bg-[#A78BFA]" : "bg-[#2E375A]"}`}
                                    ></div>
                                </div>
                        ...
                        <div className="relative my-8">
                            ...
                            <div className="relative flex justify-center text-xs font-semibold uppercase tracking-wider">
                                <span className="bg-[#050509] px-4 text-gray-500">
                                    Or continue with
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button
                                type="button"
                                className="flex items-center justify-center gap-2 border border-[#2E375A] bg-[#111119] text-sm font-medium rounded-lg p-3 hover:bg-[#1A1F36] transition duration-150"
                            >
                                <Volleyball
                                    size={18}
                        ...
                        <p className="text-center text-gray-400 mt-8 text-sm">
                            ...
                            <span
                                onClick={() => navigate("/")}
                                className="cursor-pointer text-white font-medium hover:text-[#A78BFA] hover:underline transition-colors"
                            >
                                Log In
                            </span>
                        </p>
