...
app.get("/products", (req, res) => {
    res.send([
        ...
        },
        {
            ...
            description:
                "A 12oz matte black ceramic mug. Microwave and dishwasher safe.",
            price: 14.5,
        ...
        },
        {
            ...
            description:
                "Breathable, unisex crewneck t-shirt made from 100% organic cotton.",
            price: 24.0,
            category: "Apparel",
            stock: 85,
            rating: 4.2,
        ...
        },
        {
            ...
            description:
                "Track your heart rate, sleep, and workouts with built-in GPS and waterproof design.",
            price: 149.0,
            category: "Electronics",
            stock: 30,
            rating: 4.6,
        ...
        },
        {
            ...
            description:
                "Ultrasonic diffuser with 7 ambient LED light settings and auto shut-off.",
            price: 32.99,
            category: "Home & Kitchen",
            stock: 210,
            rating: 4.7,
