        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-10">
              <div className="neu rounded-2xl h-137.5"></div>
      ...
      >
        <div className="max-w-7xl mx-auto px-5 lg:px-8 py-10">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-start">
            ...
            <div
              className="bg-white rounded-2xl p-6 lg:p-8 flex justify-center items-center min-h-105 lg:min-h-125"
            >
              <img
                src={product.thumbnail}
                alt={product.title}
                className="max-h-80 lg:max-h-180 object-contain hover:scale-105 duration-500"
              />
            </div>
